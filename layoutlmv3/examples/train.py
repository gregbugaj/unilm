...
training_args = TrainingArguments(
                                  ...
                                  output_dir="/mnt/data/models/layoutlmv3-large-finetuned-small-250",
                                  resume_from_checkpoint="/mnt/data/models/layoutlmv3-large-finetuned-small-250/checkpoint-7000",
                                  fp16=True,
                                )
print('training_args*************************')
print(training_args)
