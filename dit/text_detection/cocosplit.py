...
#python ./cocosplit.py /tmp/instances_default_merged.json /tmp/instances_training.json /tmp/instances_test.json -s .8
# Saved 31751 entries in /tmp/instances_training.json and 9065 in /tmp/instances_test.json
